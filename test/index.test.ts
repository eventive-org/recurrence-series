...
`)
    expect(series.getUpdated()).toEqual([series.getEvents()[1]])
  })
})
...
describe('setRecurrencesAndDurations', () => {
  it('changes durations of both events and adds a third', () => {
    const events = [
      {
        start: moment('2019-05-01T03:00:00.000Z').toDate(),
        end: moment('2019-05-01T04:00:00.000Z').toDate()
    ...
    expect(series.getEvents().length).toEqual(3)
    expect(series.getEvents()[0].start).toEqual(events[0].start)
    expect(series.getEvents()[0].end.toISOString()).toEqual('2019-05-01T03:00:01.000Z')
    expect(series.getEvents()[1].start).toEqual(events[1].start)
    expect(series.getEvents()[1].end.toISOString()).toEqual('2019-05-02T03:00:05.000Z')
    expect(series.getEvents()[2].start.toISOString()).toEqual('2019-05-03T03:00:00.000Z')
    expect(series.getEvents()[2].end.toISOString()).toEqual('2019-05-03T03:00:05.000Z')
    expect(series.getCreated().length).toEqual(1)
    expect(series.getCreated()[0]).toEqual(series.getEvents()[2])
    expect(series.getUpdated()).toEqual(series.getEvents().splice(0, 2))
    expect(series.getDeleted()).toEqual([])
  })
})
describe('split', () => {
